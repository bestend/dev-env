...
[[ ! -f docker-compose.yml ]] || { echo 'docker-compose.yml should be removed'; exit 1; }
...
grep -q '"dockerfile"' .devcontainer/devcontainer.json || { echo 'devcontainer should build directly from Dockerfile'; exit 1; }
